...
const Footer = () => {
  ...
  return (
    <footer className="pt-20 pb-4 px-4 md:px-6 lg:px-8 xl:px-12">
      {/* Links */}
      <div className="container mb-12 flex flex-col lg:flex-row">
        <div className="basis-1/3 flex flex-col md:items-center lg:items-start gap-4 lg:gap-6">
          <Logo />
          <p className="text-lg">
            Empowering online retailers with innovative e-commerce solutions 
            for seamless shopping experiences and business growth.
          </p>
      ...
      <div className="container border-t border-slate-700">
        <p className="capitalize pt-4 text-center lg:text-start">
          {`© ${currentYear} ocean e-commerce platform. all rights reserved.`}
        </p>
      </div>
      {/* Copyrights */}
    </footer>
